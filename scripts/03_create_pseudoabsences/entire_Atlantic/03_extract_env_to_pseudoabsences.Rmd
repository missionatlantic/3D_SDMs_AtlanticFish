---
title: "03_extract_env_to_pseudo"
...
load (here::here ("data", "derived_data", "03_create_pseudoabsences", "pseudoabsences_grouped.RData"))
...
ggplot() +
  geom_path(data = FAO_Atl, 
            ...
            color = 'gray', size = .2) +
  geom_point(data=data_noNA, aes(x=lon, y=lat, colour = "status")) 


# save the file externally

save(data, file = here::here ("data", "derived_data", "03_create_pseudoabsences", "pseudoabsences_environmental.RData"))
