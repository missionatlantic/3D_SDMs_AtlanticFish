---
title: "Mapping catches sum along the water column Tuna species"
author: "Mireia Valle"
date: "17/2/2022"
...
With this script we sum up catches from tuna species along the water column that results in a map where we can see the most productive areas of the Atlantic Ocean.
...
template <- raster(here::here ("data", "derived_data","models_sp00001", "catches", "catches_sum_atl_div", paste0("catches_sum_SP34_Thunnus alalunga.tif")))
...
#load sum catches map and rename the sum catches column
sum_catches <- raster(here::here ("data", "derived_data", "models_sp00001", "catches", "catches_sum_atl_div", paste0("catches_sum_SP",i,"_", filenames_sp[i],".tif")))
...
write.csv(all_catches_sum.df, 
          file=here::here ("data", "derived_data", "models_sp00001", "catches", "Tuna_SPECIES_catches_sum.df.csv"), 
          row.names=FALSE)
...
ggsave(filename= "Tuna_SPECIES_catches.tif", plot=p, device="tiff",
