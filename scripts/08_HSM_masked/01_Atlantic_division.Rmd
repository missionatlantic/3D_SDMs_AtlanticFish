...
n_counts_df$n_total<- as.numeric(n_counts_df$n_total)
n_counts_df$one_per<- as.numeric(n_counts_df$one_per)
n_counts_df$n_west<- as.numeric(n_counts_df$n_west)
n_counts_df$n_east<- as.numeric(n_counts_df$n_east)
n_counts_df$n_north<- as.numeric(n_counts_df$n_north)
n_counts_df$n_south<- as.numeric(n_counts_df$n_south)
