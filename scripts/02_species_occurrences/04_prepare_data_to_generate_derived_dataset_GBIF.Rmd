...
SP <- loadToEnv(file.path("data", "derived_data" , "02_species_occurrences", "02_species_occurrences_no_outliers_automatic", paste0("SP",i, "new.RData")))[[paste0("SP",i)]]
