...
#write.csv(list_validated,file=here::here ("data", "derived_data", "01_species_catches", "spp_list_validated_Atlantic.csv"))

#select top 75 species of the validated list
top_75_spp <- list_validated %>% 
  top_n(75, mean_alt) 

#write.csv(top_75_spp,file=here::here ("data", "derived_data", "01_species_catches", "top_75_spp_Atlantic.csv"))
...
#write.csv(tunas,file=here::here ("data", "derived_data", "01_species_catches", "tunas_Atlantic.csv"))
...
fish_and_tuna_list <- unique(rbind(top_75_spp, tunas)) %>% 
  dplyr::arrange(desc(mean_alt))

write.xlsx(fish_and_tuna_list, file=here::here ("data", "derived_data", "01_species_catches", "fish_and_tuna_long_list_75_Atlantic_NEW.xlsx"),append=TRUE, col.names=TRUE)
