...
FAO_Atl <- readOGR(here::here("data", "raw_data", "FAO_AREAS", "FAO_Atl_bs.shp"))
...
###Save Atlantic cells.
save(cell_atl,file=here::here ("data", "derived_data", "01_species_catches", "cell_atl_with_bs.rds"))
```

```{r}
#Load FAO Atlantic without Black sea
